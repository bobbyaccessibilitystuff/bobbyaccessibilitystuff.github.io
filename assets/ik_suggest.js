...
var pluginName = "ik_suggest",
    ...
    if(event.keyCode != ik_utils.keys.tab && event.keyCode != ik_utils.keys.esc && event.keyCode != ik_utils.keys.enter && event.keyCode != ik_utils.keys.down && event.keyCode != ik_utils.keys.up) {
